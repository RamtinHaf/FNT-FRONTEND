 ...
 */
export declare function zIndexOrdering<T>(extent: [number, number], getter: (e: T) => number, elements: Array<T>): Array<T>;
export declare function floatColor(val: string): number;
/**
 * Function returning a matrix from the current state of the camera.
 */
export declare function matrixFromCamera(state: CameraState, dimensions: {
    width: number;
    height: number;
}): Float32Array;
/**
